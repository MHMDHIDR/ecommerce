const Footer = () => (
  <nav
    className='fixed flex-no-wrap bottom-0 border border-t-gray-100 rounded-tl-3xl rounded-tr-3xl flex w-full items-center justify-between py-4 lg:flex-wrap lg:justify-start shadow-[0_-1px_7px_0_rgb(97_97_97_/_30%)]'
    data-te-navbar-ref
  >
